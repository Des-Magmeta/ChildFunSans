...
## 部件選用細則
 ...
 | 艹／⻀ | 區分，「艹」不斷開 | 不區分 | 芬芳草／繭敬蔑 | | Y
 | 匚／匸 | 統一為「匚」| 同 CL | 匡匠匣／医區匾　| | Y
 | 月／肉／舟／丹 | 前兩者統一為「月」，後兩者明確區分 | 均統一為「月」| 明／肺／朝／青 |「朝」右作舟月
 | 开／幵 | 區分 | 形刑／研妍 | 統一為「开」
 | 賣／𧶠 | 區分 | 瀆櫝讀續 | 統一為「賣」，内部兩筆方向豎直 | | Y
 | 㐄(「韋」「舛」「夅」) | 采用折角寫法 | 采用垂直寫法 | 幃傑鱗鄰降絳 | | Y
 | 牙 | 采用折角寫法 | 同 CL | 呀穿芽訝鴉 | 不采用垂直寫法 |
 | 旡(上部) |「朁」上部出頭 | 采用折角寫法，不出頭 | 僭潛簪 | CL 版「蠶」不符合規則 | Y
 | 旡(非上部) | 不出頭 | 采用折角寫法，不出頭 | 既溉概 |
 | 𠄞／亠 | 首筆直點不作短横 | 同 CL | 辛音章帝旁商意龍親毅 | 
 | 良 | 首筆爲直點 | 同 CL | 浪狼朗郎 | *CL「良」在左不避讓*；「食」上部作「亼」| Y
 | 害、憲、砉 | 首筆爲撇，豎筆穿過 | 内部作「龶」，惟首筆作撇 | | | Y
 | 契 | 前四筆從「丯」，竪以反斜綫方向微傾 | 從「丰」| 楔鍥
 | 邦 | 首筆爲撇，第三筆變提 | 前三筆平行 | 梆綁
 | 周 | 内部作「𰀁」| 内部作「土」| 凋雕稠綢
 | 呈 | 下方作「𡈼」| 同 CL | 程聖珵
 | 望 | 下方作「𡈼」| 下方作「𡈼」，右上作「𱼀」|
 | 聽 | 下方作「𡈼」| 共同部件作「王」| 廳
 | 鐵 | 下方作「𡈼」| 共同部件作「王」|
 | 刍 |「⺕」穿頭 | 同 CL | 由「芻」簡化而來的「⺕」不穿頭 | 急煞隐／邹趋
 | 关 | 上部作「八」，由「𢇇」「笑」「𣶒」簡化的作「丷」 | 上部均作「丷」 |  朕送鎹掷／联咲渕 |「关」本身獨用時，上部作「丷」
 | 兼 | 獨用形上部作「八」，作部件時參照「秉」形 | 上部作「丷」| 蒹嫌賺 | Y
 | 臽 | 上部不帶鈎 | 同 CL | 掐焰陷諂閻 | | Y
 | 忝 | 上部作「天」，「天」下横長 | 同 CL | 添舔 | Y
 | 天 | 維持原形 | 下横較長 | 蚕昊 |
 | 亡 | 左出頭 | 左不出頭 | 忙芒茫荒惘網 |
 | 冉 | 上横兩邊出頭 | 上横兩邊不出頭 | 再稱
## 參考文獻／字型
