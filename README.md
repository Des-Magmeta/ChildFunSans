...
游趣黑因笔形像笔杆一样以直线设计，而被视为一款可爱调皮，亦可以表达田园诗般气氛的字体，本人基于 Fontworks 出品的日文字体[ステッキ / Stick](https://github.com/fontworks-fonts/Stick) 扩充、调整字形，并编辑、适当增加 OpenType 特性，以满足简体中文的使用需求。
